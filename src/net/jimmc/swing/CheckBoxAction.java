 ...
 */
public class CheckBoxAction extends JCheckBox implements ActionListener {
	 ...
	 * </ul>
	 */
	public CheckBoxAction(ResourceSource resourceSource,
	...
	/** Create a button. */
	public CheckBoxAction(String label) {
		super(label);
